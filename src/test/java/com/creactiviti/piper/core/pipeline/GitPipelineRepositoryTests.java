...
public class GitPipelineRepositoryTests {
  ...
  private static class DummyGitOperations implements GitOperations {
    ...
    public List<IdentifiableResource> getHeadFiles() {
      return Arrays.asList(new IdentifiableResource("demo/hello/123", resolver.getResource("file:pipelines/demo/flows.yaml")));
    }
    @Override
    public IdentifiableResource getFile(String aFileId) {
      return new IdentifiableResource("demo/hello/123", resolver.getResource("file:pipelines/demo/flows.yaml"));
    }
